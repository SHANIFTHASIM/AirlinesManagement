...
urlpatterns = [
    ...
    path('jwt/login/', views.jwt_session_login, name='jwt-session-login'),
    path('face-verification/', views.face_verification, name='face-verification'),
    path('face-verification/process/', views.verify_face, name='verify-face'),
    ...
    path('pay-reservation/<int:reservation_id>/', views.create_payment, name='pay_reservation'),
